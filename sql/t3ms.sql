...
ALTER TABLE MOVIE_SESSION ADD CONSTRAINT "MOVIE_SESSION_NO_PK" PRIMARY KEY ("MOVIE_SESSION_NO");
...
ALTER TABLE TICKET_DETAIL ADD CONSTRAINT "TICKET_DETAIL_ORDER_NO_FK" FOREIGN KEY ("ORDER_NO") REFERENCES TICKET_ORDER ("ORDER_NO") ON DELETE CASCADE
  ADD CONSTRAINT "TICKET_DETAIL_SESSION_NO_FK" FOREIGN KEY ("SESSION_NO") REFERENCES MOVIE_SESSION ("MOVIE_SESSION_NO") ON DELETE CASCADE
...
ALTER TABLE TEAM ADD CONSTRAINT "TEAM_MEM_NO_FK" FOREIGN KEY ("MEM_NO") REFERENCES MEMBER ("MEM_NO") ON DELETE CASCADE
  ADD CONSTRAINT "TEAM_MOVIE_SESSION_NO_FK" FOREIGN KEY ("MOVIE_SESSION_NO") REFERENCES MOVIE_SESSION ("MOVIE_SESSION_NO") ON DELETE CASCADE;
