...
//		}
		...
		// ----------------SELECT NOW MOVIE--------------
	// ----------------SELECT Comingsoon MOVIE--------------
		
//		List<MovieVO> list = dao.getComingsoon();
//		for (MovieVO amovie : list) {
//			System.out.println(amovie.getMovie_no() + ",");
//			System.out.println(amovie.getMovie_type() + ",");
//			System.out.println(amovie.getMovie_name() + ",");
