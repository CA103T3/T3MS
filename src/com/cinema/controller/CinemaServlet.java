    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if ("insert".equals(action)) { // from addCinema.jsp
            ...
            try {
                ...
                String cinema_nameReg = "^[(\u4e00-\u9fa5)(a-zA-Z0-9\\s)]{1,50}$";
...
//                    System.out.println("影城名稱: 請勿空白");
                    ...
                    errorMsgs.add("影城名稱: 只能是中、英文字母、空白和數字, 且長度必需在1到50之間");
                }
                ...
                String cinema_addressReg = "^[(\\(\u4e00-\u9fa5\\)\\s)(a-zA-Z0-9-)]{3,50}$";
                ...
                String photo_titleReg = "^[(\u4e00-\u9fa5)(a-zA-Z0-9-_\\s)]{1,30}$";
                ...
                if (photo_title == null || photo_title.trim().length() == 0) {
                    ...
                    errorMsgs.add("圖片名稱: 只能是中、英文字母、數字和-_, 且長度必需在1到30之間");
                }
...
//                    System.out.println("影城名稱: 請勿空白");
                ...
                CinemaService cSvcTemp = new CinemaService();
                CinemaVO oldCinemaVO = cSvcTemp.getOneCinema(cinema_no);
                ...
                if (filename != null && part.getContentType() != null) {
                    ...
                    //fill old data
                    photo_path = oldCinemaVO.getPhoto_path();
                    photo_small = oldCinemaVO.getPhoto_small();
                }
                ...
                CinemaVO cinemaVO = new CinemaVO();
                cinemaVO.setCinema_no(cinema_no);  //different from "insert" of action
                cinemaVO.setCinema_name(cinema_name);
                cinemaVO.setCinema_engname(cinema_engname);
                cinemaVO.setCinema_address(cinema_address);
                cinemaVO.setCinema_tel(cinema_tel);
                ...
                if (oldCinemaVO == null) {
                    ...
                    cinemaVO.setPhoto_small(oldCinemaVO.getPhoto_small());
                }
...
//                    System.out.println("errorMsgs.size() : " + errorMsgs.size());
                ...
                /*************************** 2.開始修改資料 *****************************************/
                CinemaService cSvc = new CinemaService();
                cSvc.updateCinema(cinema_no, cinema_name, cinema_engname, cinema_address, cinema_tel, introduction,
                        traffic, photo_title, photo_path, photo_small, active, state);
...
//            System.out.println("url: " + url);
        ...
        if ("toUpdatePage".equals(action)) { // from listAllCinema.jsp
