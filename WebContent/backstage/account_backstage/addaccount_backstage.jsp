...
<!-- 	</tr> -->
	...
	<tr><!--多出來  -->
		<td>角色權限:</td>
		<td><input type="checkbox" name="PERMISSION_NO" size="100"
			 value="<%= (role_Permission_BsVO==null)? "1" : role_Permission_BsVO.getPermission_no()%>" />檢舉管理
			 
		<input type="checkbox" name="PERMISSION_NO" size="45"
			 value="<%= (role_Permission_BsVO==null)? "2" : role_Permission_BsVO.getPermission_no()%>" />會員帳號管理
