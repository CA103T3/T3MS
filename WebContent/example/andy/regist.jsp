				...
				<form>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="validationDefault03">電子信箱</label>
							<input type="text" class="form-control" id="validationDefault03" name="email" required>
						</div>
						<div class="col-md-3 mb-3">
							<label for="validationDefault04">密碼</label>
							<input type="text" class="form-control" id="validationDefault04" name="paw" required>
						</div>
						<div class="col-md-3 mb-3">
							<label for="validationDefault05">確認密碼</label>
							<input type="text" class="form-control" id="validationDefault05" name="paw2" required>
						</div>
					</div>
					<hr>
					...
					<div class="form-row">
						<div class="col-md-4 mb-3">
							...
							<input type="text" class="form-control" id="validationDefault01" name="Last name" value="陳" required>
						</div>
						<div class="col-md-4 mb-3">
							<label for="validationDefault02">名字</label>
							<input type="text" class="form-control" id="validationDefault02" name="First name" value="平偉" required>
						</div>
						<div class="col-md-4 mb-3">
							<label for="validationDefaultUsername">生日</label>
							<div class="input-group">
								<input type="date" class="form-control" id="validationDefaultUsername" name="birthday" aria-describedby="inputGroupPrepend2" required>
							</div>
						</div>
					</div>
					...
					<div class="form-row">
						...
						<div class="col-md-4 mb-3">
							...
							<input type="text" class="form-control" id="" name="id" value="A81000" required>
						</div>
						<div class="col-md-4 mb-3">
							<label for="validationDefault02">性別<br>
							<div class="custom-control custom-radio">
								<input type="radio" id="customRadio1" name="gender" class="custom-control-input" value="male">&nbsp&nbsp&nbsp&nbsp&nbsp
								<label class="custom-control-label" for="customRadio1">&nbsp男</label>
							</div>
							<div class="custom-control custom-radio">
								<input type="radio" id="customRadio2" name="gender" class="custom-control-input" value="female">&nbsp&nbsp&nbsp&nbsp&nbsp
					...
					<div class="form-row">
						...
						<div class="col-md-4 mb-3">
							<label>郵遞區號</label>
							<input type="text" class="form-control" id="" name="zip" value="120" required>
						</div>
					</div>
					<hr class="hrno">
					<div class="form-row">
