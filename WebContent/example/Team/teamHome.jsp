...
#London {background-color:pink;}
#Paris {background-color:powderblue;}
...
<form class="filter-list" style="">
  ...
  <label for="formControlsSelect1" class="control-label">
    <span>日期</span>
  </label>
...
<!--執行 Date Range Picker-->
  ...
  <div class="form-group">
    <label class="control-label"><span>城市</span></label>
    <select placeholder="select" id="countryId" class="form-control">
  ...
  <div class="form-group"><label class="control-label"><span>所在地</span></label><select placeholder="select" id="cityId" class="form-control">
    <option value=""><span>隨便</span></option>
    <option value="1">臺北</option>
    <option value="2">新北</option>
    <option value="3">基隆</option>
  ...
  <select placeholder="select" id="tagId" class="form-control">
    <option value=""><span>隨便</span></option>
  ...
  <div class="form-group">
    ...
    <input type="text" placeholder="搜尋聚會名稱、好友暱稱" id="keywords" class="form-control">
  </div>

  <div class="form-group">
    <button type="button" class="btn-yellow btn btn-default btn-block">
    <span class="middle icon icon-search"></span>
    <span class="middle"><span>搜尋</span></span></button>
    <button type="button" class="btn-grey btn btn-default btn-block"><span>重置</span></button>
  </div>
  ...
  <footer >
    <div class="container ">
      ...
      <p class="text-center">Album template is based on Bootstrap © examples.&nbsp;
        <br>New to Bootstrap?
